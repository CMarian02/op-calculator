...
class MainPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        main_frame = tk.Frame(self, width = 520, height = 520, bg = "#343131")
        main_frame.pack(fill = "both", expand = True)
        display_frame = tk.Frame(main_frame, width = 520, height = 120, bg = "#343131")
        display_frame.pack(fill = "both", expand = True)
        self.eq_label = tk.Label(display_frame,text = "", font = ("Bebas Neue", 20), bg = "#343131", fg = "#DFDFDF")
        self.eq_label.place(relx = 1, x = 0, y = 0, anchor = "ne")
        self.eq2_label = tk.Label(display_frame, text ="", font = ('Bebas Neue', 35), bg = "#343131", fg = "#EBFCF5")
        ...
        button_clearone = tk.Button(button_frame, text = "CC", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("CC", 0))
        button_clearone.grid(row = 0, column = 1, stick = tk.W)
        self.controller.bind("<BackSpace>", lambda event: self.button_pressed("CC", 0))
        button_mod = tk.Button(button_frame, text = "%", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("%", 0))
        button_mod.grid(row = 0, column = 2, sticky = tk.W)
        self.controller.bind("%", lambda event: self.button_pressed("%", 0))
        button_div = tk.Button(button_frame, text = "/", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =100, height = 80, cursor = "hand2", command = lambda:self.button_pressed("/", 0))
        button_div.grid(row = 0, column = 3, sticky = tk.W)
        self.controller.bind("/", lambda event: self.button_pressed("/", 0))
        button_sev = tk.Button(button_frame, text = "7", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 7))
        button_sev.image = NonePhoto
        button_sev.grid(row = 1, column = 0)
        self.controller.bind("7", lambda event: self.button_pressed("Number", 7))
        button_eig = tk.Button(button_frame, text = "8", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 8))
        button_eig.grid(row = 1, column = 1)
        self.controller.bind("8", lambda event: self.button_pressed("Number", 6))
        button_nin = tk.Button(button_frame, text = "9", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 9))
        button_nin.grid(row = 1, column = 2)
        self.controller.bind("9", lambda event: self.button_pressed("Number", 9))
        button_mul = tk.Button(button_frame, text = "X", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =100, height = 80, cursor = "hand2", command = lambda:self.button_pressed("X", 0))
        button_mul.grid(row = 1, column = 3)
        self.controller.bind("*", lambda event: self.button_pressed("X", 0))
        button_fou = tk.Button(button_frame, text = "4", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 4))
        button_fou.grid(row = 2, column = 0)
        self.controller.bind("4", lambda event: self.button_pressed("Number", 4))
        button_fiv = tk.Button(button_frame, text = "5", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 5))
        button_fiv.grid(row = 2, column = 1)
        self.controller.bind("5", lambda event: self.button_pressed("Number", 5))
        button_six = tk.Button(button_frame, text = "6", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 6))
        button_six.grid(row = 2, column = 2)
        self.controller.bind("6", lambda event: self.button_pressed("Number", 6))
        button_min = tk.Button(button_frame, text = "-", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =100, height = 80, cursor = "hand2", command = lambda:self.button_pressed("-", -1))
        button_min.grid(row = 2, column = 3)
        self.controller.bind("-", lambda event: self.button_pressed("-", -1))
        button_one = tk.Button(button_frame, text = "1", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 1))
        button_one.grid(row = 3, column = 0)
        self.controller.bind("1", lambda event: self.button_pressed("Number", 1))
        button_two = tk.Button(button_frame, text = "2", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 2))
        button_two.grid(row = 3, column = 1)
        self.controller.bind("2", lambda event: self.button_pressed("Number", 2))
        button_thr = tk.Button(button_frame, text = "3", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 3))
        button_thr.grid(row = 3, column = 2)
        self.controller.bind("3", lambda event: self.button_pressed("Number", 3))
        button_plu = tk.Button(button_frame, text = "+", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =100, height = 80, cursor = "hand2", command = lambda:self.button_pressed("+", 0))
        button_plu.grid(row = 3, column = 3)
        self.controller.bind("+", lambda event: self.button_pressed("+", 0))
        button_next_pag = tk.Button(button_frame, text = ">>", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed(">>", 0))
        button_next_pag.grid(row = 4, column = 0)
        button_zer = tk.Button(button_frame, text = "0", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed("Number", 0))
        button_zer.grid(row = 4, column = 1)
        self.controller.bind("0", lambda event: self.button_pressed("Number", 0))
        button_dig = tk.Button(button_frame, text = ",", font = ('Bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =140, height = 80, cursor = "hand2", command = lambda:self.button_pressed(",", 0))
        button_dig.grid(row = 4, column = 2)
        self.controller.bind(",", lambda event: self.button_pressed(",", 0))
        button_ans = tk.Button(button_frame, text = "=", font = ('bebas Neue', 20),bg = "#242221", fg = "#DE6639",borderwidth = 0, image = NonePhoto, compound = "c", width =100, height = 80, cursor = "hand2", command = lambda:self.button_pressed("=", 0))
        button_ans.grid(row = 4, column = 3)
        self.controller.bind("<Return>", lambda event: self.button_pressed("=", 0))
        
        #Global Variables
        global number_is, z , round_factor, second_operator, operator, numbers_created, number_two, number_one, btn_press, high_round_n1, high_round_n2
        second_operator = 0
        z = 1
        operator = 0 
        round_factor = 0
        number_is = 0
        numbers_created = False
        high_round_n1 = 0
        high_round_n2 = 0
        btn_press = 0
    ...
    def button_pressed(self, button_type, number):
        ...
        #Verify if you pres ','
        if button_type == "," and btn_press != 0:
            if len(str(number_one)) < 12 and number_is == 0:
                btn_press = -1
                operator = ","
            elif len(str(number_two)) < 12 and number_is == 2:
                btn_press = -1
                operator = ","
            else:
        ...
        if button_type == "CC" and btn_press != 0:
            if number_is != 2:
                if operator == ',':
                    if len(str(int(z))) == 2:
        ...
        if button_type == "=" and btn_press != 0 and numbers_created == True:
            ...
            if operator == "/":
                if number_two != 0:
                    ...
                    final_ec = "You can't devide with 0."
                    self.eq2_label.config(text = "")
            if operator == "%":
                if number_two != 0:
                    display = number_one % number_two
                    ...
                    final_ec = "You can't modulo with 0."
                    self.eq2_label.config(text = "")
